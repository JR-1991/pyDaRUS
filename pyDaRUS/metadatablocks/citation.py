...
class Citation(DataverseBase):
    ...
    related_material: Optional[str] = Field(
        None,
    ...
    related_datasets: Optional[str] = Field(
        None,
    ...
    did_it_work_: Optional[str] = Field(
        None,
        alias='did_it_work?',
    ...
    def add_author(
        ...
        Args:
            ...
            identifier_scheme (string): Name of the identifier scheme (ORCID, ISNI).
    ...
    def add_contact(
        ...
        Args:
            ...
            e_mail (string): The e-mail address(es) of the contact(s) for the Dataset. This will not be displayed.

        """

        self.contact.append(
            Contact(
                name=name, affiliation=affiliation, e_mail=e_mail
            )
        )
    ...
    def add_contributor(
        ...
        Args:
            ...
            type (string): The type of contributor of the  resource.  
    ...
    def add_related_publication(
        ...
        Args:
            ...
            id_type (string): The type of digital identifier used for this publication (e.g., Digital Object Identifier (DOI)).
