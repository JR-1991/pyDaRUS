...
class CodeMeta(DataverseBase):
    ...
    operating_systems: Optional[str] = Field(
        None,
    ...
    application_subcategory: Optional[str] = Field(
        None,
    ...
    software_help_documentation: Optional[str] = Field(
        None,
        alias='software_help/documentation',
    ...
    processor_requirements: Optional[str] = Field(
        None,
    ...
    continous_integration: Optional[str] = Field(
        None,
