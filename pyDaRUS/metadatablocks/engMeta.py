...
class EngMeta(DataverseBase):
    data_generation: Optional[str] = Field(
        None,
    ...
    def add_spatial_resolution(
        ...
        number_of_blocks: Optional[int],
        number_of_points_x: Optional[int],
        number_of_points_y: Optional[int],
        number_of_points_z: Optional[int],
        interval_x: Optional[float],
        interval_y: Optional[float],
        interval_z: Optional[float],
        unit: Optional[str],
        scaling_formular: Optional[str],
    ):
    ...
    def add_temporal_resolution(
        self,
        points: Optional[str],
        number_of_time_steps: Optional[int],
