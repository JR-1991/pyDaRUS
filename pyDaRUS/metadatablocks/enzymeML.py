...
#   timestamp: 2022-01-05T17:29:38+00:00
...
class Constant(Enum):
    """
    Specifies if the reactants concentation was constant or not. If a reactant serves as a substrate/product, concentrations are likely to change and this field should be set to 'Not constant'.
    """
