...
#   timestamp: 2021-12-28T01:05:22+00:00
...
class Environments(DataverseBase):
    ...
    compiler_names_and_flags: Optional[str] = Field(
        None,
...
class Process(DataverseBase):
    ...
    def add_environments(
        self,
        name: Optional[str],
        compiler_names_and_flags: Optional[str],
        ...
        Args:
            ...
            compiler_names_and_flags (string): Name and flags of the used compilers.
    ...
    def add_instruments(
        ...
        Args:
            ...
            part_number (string): A vendors part number for an instrument or a piece of equipment.
            serial_number (string): A vendors serial number for an instrument or a piece of equipment.
    ...
    def add_processing_steps(
        ...
        Args:
            ...
            type (string): Specifies the position in the data life cycle.
            ...
            input (string): Name of the file or object that was the input of this processing step
            output (string): Name of the file or object that was the output of this processing step
    ...
    def add_software(
        ...
        Args:
            ...
            id_type (string): The type of digital identifier used for this software (e.g., Digital Object Identifier (DOI)).
